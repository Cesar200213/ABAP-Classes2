...
CLASS zcl_main_cmo IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA: lt_customers TYPE TABLE OF ztcustomer_cmo,   " Definir tabla interna para los clientes
    ...
    DELETE FROM ztcustomer_cmo.  " Eliminar registros previos

    INSERT ztcustomer_cmo FROM TABLE @lt_customers.  " Insertar nuevos registros desde la tabla interna
